(function () {
  ...
  function B1ackMemoryPage() {
    ...
    if (error) {
      return React.createElement("div", { style: { padding: "1rem", color: "#ff8b8b" } }, "B1ack Memory 加载失败：" + error);
    }
    if (!documentHtml) {
      return React.createElement("div", { style: { padding: "1rem", color: "var(--color-muted-foreground, #9ca3af)" } }, "正在加载 B1ack Memory…");
    }
